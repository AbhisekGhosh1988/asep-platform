...
public class ProjectSummaryController {
    ...
    public ApiResponse<ProjectSummaryResponse> summary(@PathVariable String projectId) {

        return ApiResponse.success("Project summary retrieved successfully", useCase.execute(projectId));
