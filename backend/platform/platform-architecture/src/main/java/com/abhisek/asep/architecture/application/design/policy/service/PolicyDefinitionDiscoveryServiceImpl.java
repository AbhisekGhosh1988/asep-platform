...
import com.abhisek.asep.architecture.application.design.policy.ai.workflow.PolicyDefinitionDiscoveryWorkflow;
...
public class PolicyDefinitionDiscoveryServiceImpl implements PolicyDefinitionDiscoveryService {
    ...
    private final PolicyDefinitionDiscoveryWorkflow workflow;

    @Override
    public PolicyDefinitionDiscoveryResponse discover(String aggregateId) {
