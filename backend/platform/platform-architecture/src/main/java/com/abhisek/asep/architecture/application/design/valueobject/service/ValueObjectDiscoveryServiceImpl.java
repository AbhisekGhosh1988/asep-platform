...
import com.abhisek.asep.architecture.application.design.valueobject.ai.workflow.ValueObjectDiscoveryWorkflow;
...
public class ValueObjectDiscoveryServiceImpl implements ValueObjectDiscoveryService {
    ...
    private final ValueObjectDiscoveryWorkflow workflow;

    @Override
    public ValueObjectDiscoveryResponse discover(String aggregateId) {
