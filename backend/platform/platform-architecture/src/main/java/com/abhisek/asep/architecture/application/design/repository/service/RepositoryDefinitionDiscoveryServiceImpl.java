...
import com.abhisek.asep.architecture.application.design.repository.ai.workflow.RepositoryDefinitionDiscoveryWorkflow;
...
public class RepositoryDefinitionDiscoveryServiceImpl implements RepositoryDefinitionDiscoveryService {
    ...
    private final RepositoryDefinitionDiscoveryWorkflow workflow;

    @Override
    public RepositoryDefinitionDiscoveryResponse discover(String aggregateId) {
