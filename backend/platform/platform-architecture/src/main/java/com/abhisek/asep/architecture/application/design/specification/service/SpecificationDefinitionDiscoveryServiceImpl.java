...
import com.abhisek.asep.architecture.application.design.specification.ai.workflow.SpecificationDefinitionDiscoveryWorkflow;
...
public class SpecificationDefinitionDiscoveryServiceImpl implements SpecificationDefinitionDiscoveryService {
    ...
    private final SpecificationDefinitionDiscoveryWorkflow workflow;

    @Override
    public SpecificationDefinitionDiscoveryResponse discover(String aggregateId) {
        ...
        return workflow.execute(buildAggregateModel(aggregate, entities));
